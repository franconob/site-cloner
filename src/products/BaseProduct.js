...
var BaseProduct, EventEmitter, exec, fs, hogan, mysql, utils, _,
...
BaseProduct = (function(_super) {
  ...
  function BaseProduct(config, vars, subdomain, destDir) {
    ...
    this.dbName = "lp_" + this.subdomain + "_" + this.subdomain;
    this.configFileVars = {
  ...
  BaseProduct.prototype.compileDb = function(callback) {
    var _this = this;
    return fs.readFile(this._getPath(this.destDir, BaseProduct.DBFILE), {
      encoding: 'utf8'
    }, function(err, data) {
      var template;
      if (err) {
  ...
  BaseProduct.prototype._getPath = function(dir, file) {
